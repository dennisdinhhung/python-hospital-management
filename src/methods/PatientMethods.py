...
def doctors_assignment(pat_subwin, pat_tree, fulwidth, fulheight, pa_doc_list, doctors_list, assigned_doctors_list, unassigned_doctors_list):
    if selected_patient != -1:    
        ...
        Label(patda_subwin, text='ASSIGNED DOCTORS', bg='#ceede8', fg='white', font=("Work Sans", 20, 'bold')).place(x=50,y=50,width=fulwidth/2-100,height=50)
        Label(patda_subwin, text='UNASSIGNED DOCTORS', fg='#ceede8', font=("Work Sans", 20, 'bold')).place(x=fulwidth/2+50,y=50,width=fulwidth/2-100,height=50)
        ...
        Label(patda_subwin, text=f"COUNT: {assigned_doctors_count}", anchor='e', bg='#ceede8', fg='black', font=("Work Sans", 16, 'bold')).place(x=fulwidth/4+50,y=fulheight-150,width=200,height=50)
        ...
        # Buttons
        assign_doctor_button = Button(patda_subwin, text='ASSIGN DOCTOR', font=("Work Sans", 16, 'bold'), fg='white', bg='#ceede8', relief='ridge',
        ...
        unassign_doctor_button = Button(patda_subwin, text='UNASSIGN DOCTOR', font=("Work Sans", 16, 'bold'), fg='#ceede8', relief='ridge',
...
def room_asignment(pat_subwin, pat_tree, fulwidth, fulheight, pa_room_list, room_list, assigned_room_list, unassigned_room_list):
    if selected_patient != -1:    
        ...
        Label(patma_subwin, text='ASSIGNED ROOMS', bg='#ceede8', fg='white', font=("Work Sans", 20, 'bold')).place(x=50,y=50,width=fulwidth/2-100,height=50)
        Label(patma_subwin, text='UNASSIGNED ROOMS', fg='#ceede8', font=("Work Sans", 20, 'bold')).place(x=fulwidth/2+50,y=50,width=fulwidth/2-100,height=50)
        ...
        # ===============================================================================
        Label(patma_subwin, text=f"COUNT: {assigned_room_count}", anchor='e', bg='#ceede8', fg='black', font=("Work Sans", 16, 'bold')).place(x=fulwidth/4+50,y=fulheight-150,width=200,height=50)
        ...
        # Buttons
        assign_room_button = Button(patma_subwin, text='ASSIGN ROOM', font=("Work Sans", 16, 'bold'), fg='white', bg='#ceede8', relief='ridge',
        ...
        unassign_room_button = Button(patma_subwin, text='UNASSIGN ROOM', font=("Work Sans", 16, 'bold'), fg='#ceede8', relief='ridge',
...
def pat_press(window, fulwidth, fulheight, doctors_list, patients_list, room_list, pa_doc_list, pa_room_list):
    ...
    Label(pat_subwin, bg='#ceede8', fg='white', text='PATIENTS MANAGEMENT', font=("Work Sans", 20, 'bold')).place(x=50, y=25, width=fulwidth/2-100, height=50)
    Frame(pat_subwin, bg='crimson').place(x=50, y=85, width=fulwidth/2-100, height=2)
    entry_frame = Frame(pat_subwin, bg='#ceede8')
    ...
    Label(pat_subwin, text=' - Entries marked with " * " must not be empty ', anchor='w', bg='#ceede8', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=360, height=30)
    Label(pat_subwin, text=' - ID must be " P-xxx " ', anchor='w', bg='#ceede8', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=385, height=30)
    Label(pat_subwin, text=' - Gender must be " M " or " F " ', anchor='w', bg='#ceede8', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=410, height=30)
    Label(pat_subwin, text=' - Date of Birth must be " dd/mm/yyyy " ', anchor='w', bg='#ceede8', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=435, height=30)
    Label(pat_subwin, text=' - Phone & Debt must be numbers ', anchor='w', bg='#ceede8', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=460, height=30)
    ...
    Label(entry_frame, bg='#ceede8', fg='white', text=' - Illness - ', font=("Work Sans", 14, 'bold')).grid(column=2, row=6)
    Label(entry_frame, bg='#ceede8', fg='white', text=' - Debt - ', font=("Work Sans", 14, 'bold')).grid(column=2, row=7)
    ...
    # Buttons
    add_patient_button = Button(pat_subwin, text='ADD PATIENT',anchor='center',font=("Work Sans", 12,'bold'), fg='#ceede8', relief='ridge',
    ...
    update_patient_button = Button(pat_subwin, text='UPDATE',anchor='center',font=("Work Sans", 12,'bold'), fg='#ceede8', relief='ridge',
    ...
    select_patient_button = Button(pat_subwin, text='SELECT',anchor='center',font=("Work Sans", 12,'bold'), bg='#ceede8',fg='white', relief='ridge',
    ...
    doctors_assignment_button = Button(pat_subwin, text='DOCTORS ASSIGNMENT',anchor='center',font=("Work Sans", 12,'bold'), bg='white',fg='#ceede8', relief='ridge',
    ...
    room_assignment_button = Button(pat_subwin, text='ROOMS ASSIGNMENT',anchor='center',font=("Work Sans", 12,'bold'), bg='white',fg='#ceede8', relief='ridge',
