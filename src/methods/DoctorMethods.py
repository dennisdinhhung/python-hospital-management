...
def doc_press(window, fulwidth, fulheight, doctors_list, patients_list, pa_doc_list):
    ...
    remove_doctor_button = Button(doc_subwin, text='REMOVE SELECTED',anchor='center',font=("Work Sans", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    remove_all_doctor_button = Button(doc_subwin, text='REMOVE ALL',anchor='center',font=("Work Sans", 12,'bold'),bg='red', fg='white', relief='ridge',
