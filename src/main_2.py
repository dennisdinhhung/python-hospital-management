...
# Left Panel
Frame(window, bg="#ceede8").place(x = fulwidth/2, y = 0, width = fulwidth/2, height = fulheight)
...
# Right Panel
Label(window, text="HOSPITAL INFORMATION",bg="#ceede8", fg="white", font=("Ariel", 25,'bold')).place(x = fulwidth/2, y = fulheight-250, width=fulwidth/2, height=25)
Label(window, text="MANAGEMENT SYSTEM",bg="#ceede8", fg="white", font=("Ariel", 25,'bold')).place(x = fulwidth/2, y = fulheight-200, width=fulwidth/2, height=25)
Label(window, image=HospitalImg, bg="#ceede8", anchor='center').place(x = (fulwidth/8)*6-125, y=(fulheight/7), width=250, height=250)


# Buttons
doctors_button = Button(window, text="DOCTORS", anchor='center', font=("Ariel", 20,'bold'), bg="#ceede8", fg="white", relief='ridge', 
...
workers_button = Button(window, text="WORKERS", anchor='center', font=("Ariel", 20,'bold'), bg="#ceede8", fg="white", relief='ridge', 
...
patients_button = Button(window, text="PATIENTS", anchor='center', font=("Ariel", 20,'bold'), bg="#ceede8", fg="white", relief='ridge', 
...
room_button = Button(window, text="ROOM", anchor='center', font=("Ariel", 20,'bold'), bg="#ceede8", fg="white", relief='ridge', 
